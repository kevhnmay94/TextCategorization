...
def summarize_text_id(input_text:str, max_length_ratio=0.0, max_length_character=0, language='auto'):
    target_ratio = 0.0
...
def summarize_text_en(input_text:str, max_length_ratio=0.0, max_length_character=0, language='auto'):
    ...
    #     return translated
        # translate_summary = translator.translate(summary,src='en', dest='id')
        # return translate_summary.text
def summarize_text_nohtml(input_text:str, max_length_ratio=0.0, max_length_character=0, language='auto'):
    target_ratio = 0.0
    if(max_length_ratio==0.0 and max_length_character==0):
        return "[Error] Error in summarizing article."
    elif max_length_ratio == 0.0:
    ...
    if language_true == 'id':
        ...
        # translate_summary = translator.translate(summary,src='en', dest='id')
        # return translate_summary.text
def summarize_text_en_nohtml(input_text:str, max_length_ratio=0.0, max_length_character=0, language='auto'):
    target_ratio = 0.0
    if(max_length_ratio==0.0 and max_length_character==0):
        return "[Error] Error in summarizing article."
    elif max_length_ratio == 0.0:
